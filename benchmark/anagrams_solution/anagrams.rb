...
def anagram_performance_tests(size)
  alphabet = ("a".."z").to_a
  str1 = ""
  size.times { str1 << alphabet.sample }
  str2 = str1

  Benchmark.bm(24) do |x|
    # x.report("first anagram:") {first_anagram?(str1, str2)}
    # x.report("second anagram:") {second_anagram?(str1, str2)}
    # x.report("third anagram:") {third_anagram?(str1, str2)}
    x.report("fourth anagram:") {fourth_anagram?(str1, str2)}
    x.report("fourth anagram one hash:") {fourth_anagram_one_hash?(str1, str2)}
  end
end

# anagram_performance_tests(10000000)